...
def vercheck(args: Namespace) -> bool:
    ...
    from am232x.constants import version as am232x_version
    act_version = "v{version}".format(version=am232x_version)
    logger.info("am232x version: {act_version}, Provided version: {exp_version}"
    ...
    if output is None or output == "-":
        ...
        with open(output, "w") as f:
            comment = ("# DO NOT EDIT THIS FILE MANUALLY.\n"
                       "# This file is generated by manage.py (Python {py_ver}).\n"
                       "# Please edit setup.cfg if you want to change dependencies.\n"
                       .format(py_ver=platform.python_version()))
            f.write(comment + requires)
    return True
